...
void keyboard_init(void) {
    ...
    /*=========================================================================
     * INITIALIZATION: Ensure Keyboard IRQ is Enabled at Boot
     *
     * Explicitly enable IRQ1 (keyboard) on the PIC and set state flag.
     * This ensures the system starts in a known-good state where keyboard
