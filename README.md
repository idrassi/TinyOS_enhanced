...
On first boot it asks you to set a root password, then drops to a shell. Try `ls`, `ls C:`, `ls D:`, and `exec /hello.elf`.
...
Deeper documentation lives in [`doc/`](doc/) — notably `doc/OS_COMPARISON_AND_GRADE.md` (where this kernel sits vs. xv6 / ToaruOS / SerenityOS and real-world tiny OSes) and `doc/MULTI_AGENT_SECURITY_AUDIT_2026.md` (the security audit history).
